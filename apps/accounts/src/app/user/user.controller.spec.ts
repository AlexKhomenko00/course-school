...
describe('UserController', () => {
  ...
  it('AccountsUserInfo', async () => {
    const res = await rmqService.triggerRoute<
      AccountsUserInfo.Request,
      AccountsUserInfo.Response
    >(AccountsUserInfo.topic, { id: userId });
  ...
  it('BuyCourse', async () => {
    ...
    const res = await rmqService.triggerRoute<
      AccountsBuyCourse.Request,
      AccountsBuyCourse.Response
    >(AccountsBuyCourse.topic, { userId, courseId });
  ...
  it('BuyCourse', async () => {
    ...
    const res = await rmqService.triggerRoute<
      AccountsCheckPayment.Request,
      AccountsCheckPayment.Response
    >(AccountsCheckPayment.topic, { userId, courseId });
